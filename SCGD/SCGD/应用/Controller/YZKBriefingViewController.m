...
@interface YZKBriefingViewController() <YZKSearchBarViewDelegate, UITableViewDelegate, UITableViewDataSource>
...
@implementation YZKBriefingViewController
...
- (void)loadFreshBriefing{
    _page = 1;
    [self.dataController requestDataWithType:briefingType params:nil success:^{
...
- (UITableView *)tableView{
    if (_tableView == nil) {
        ...
        _tableView.mj_header = [MJRefreshNormalHeader headerWithRefreshingTarget:self refreshingAction:@selector(loadFreshBriefing)];
        _tableView.mj_footer = [MJRefreshAutoNormalFooter footerWithRefreshingTarget:self refreshingAction:@selector(loadMoreBriefing)];
