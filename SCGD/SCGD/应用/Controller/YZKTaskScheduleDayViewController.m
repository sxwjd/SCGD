//
//  YZKTaskScheduleDayViewController.m
//  SCGD
//
...
@interface YZKTaskScheduleDayViewController ()<UITableViewDelegate, UITableViewDataSource, YZKDateChooseViewDelegate>
{
    NSString *_year;
    NSString *_month;
    NSString *_day;
...
@implementation YZKTaskScheduleDayViewController
...
- (void)dateChooseView:(YZKDateChooseView *)view withSelectedYearMonth:(NSString *)year month:(NSString *)month day:(NSString *)day{
    ...
    _page = 1;
    [self.dataController requestDataWithScheduleType:taskType specifyYearMonthDay:_searchField params:params success:^{
...
- (void)loadMoreSchedule{
    ...
    [self.dataController requestDataWithScheduleType:taskType specifyYearMonthDay:_searchField params:params success:^{
        NSLog(@"%ld",self.dataController.dataList.count);
